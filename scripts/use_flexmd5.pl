...
if (defined $ENV{KB_DEPLOYMENT_CONFIG} && -e $ENV{KB_DEPLOYMENT_CONFIG}) {
    ...
    $cfg->param('homology_service.flexmd5_tt','/homes/brettin/local/dev_container/modules/homology_service/templates/flexmd5.tt');
}
...
if ( $ih ) {
  while (<$ih>) {
    ...
    my $md5_file = $path . $name . ".flexmd5.tab";
